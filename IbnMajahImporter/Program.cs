...
namespace IbnMajahImporter;

/// <summary>
/// Importer dédié pour Sunan Ibn Majah depuis sunnah.com
/// </summary>
public class Program
{
    ...
    {
        Console.WriteLine("🕌 SUNAN IBN MAJAH DIRECT IMPORT");
        Console.WriteLine("=================================");
        ...
        try
        {
            ...
            Console.WriteLine("📚 Starting Sunan Ibn Majah import...");
            
            var hadiths = await ImportIbnMajahAsync();
            
            // Sauvegarder en JSON
            var outputPath = "../Tools/sunan_ibnmajah_complete.json";
    ...
    private static async Task<List<HadithRecord>> ImportIbnMajahAsync()
    {
        var allHadiths = new List<HadithRecord>();
        
        // Récupérer la page principale
        Console.WriteLine("🔗 Fetching: https://sunnah.com/ibnmajah");
        var mainHtml = await GetPageContentAsync("https://sunnah.com/ibnmajah");
        ...
        Console.WriteLine($"📖 Found {books.Count} books in Sunan Ibn Majah");
    ...
    private static List<BookInfo> ExtractBooks(string html)
    {
        ...
        var bookNodes = doc.DocumentNode.SelectNodes("//a[contains(@href, '/ibnmajah/')]");
        ...
        if (bookNodes != null)
        {
            foreach (var bookNode in bookNodes)
            {
                ...
                var match = Regex.Match(href, @"/ibnmajah/(\d+)");
    ...
    private static async Task<List<HadithRecord>> ImportBookAsync(BookInfo book)
    {
        ...
        var bookUrl = $"{_baseUrl}/ibnmajah/{book.Number}";
    ...
    private static string DetermineGrade(string gradeText)
    {
        ...
        // Pour Sunan Ibn Majah, par défaut Hasan (collection respectée)
        return "Hasan";
    }
